...
namespace CommerceV3.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create
            ([Bind("Id,Name,Slug,Description,OldPrice,Price,Quantity,IsInStock,IsPublished,IsNew,ShippingPriceCityWide," +
            "ShippingPriceCountryWide,ShippingPriceWorldWide,SupplierId,BrandId,CreatedBy,CreateDate,UpdatedBy,UpdateDate,Photo")]
        Product product, IFormFile upload)
        {
        ...
        public async Task<IActionResult> Edit
            (string id, [Bind("Id,Name,Slug,Description,OldPrice,Price,Quantity,IsInStock,IsPublished,IsNew,ShippingPriceCityWide," +
            "ShippingPriceCountryWide,ShippingPriceWorldWide,SupplierId,BrandId,CreatedBy,CreateDate,UpdatedBy,UpdateDate,Photo")]
        Product product, IFormFile upload)
        {
            if (id != product.Id)
